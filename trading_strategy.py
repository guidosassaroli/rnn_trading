...
# we are looking into the graphs and tryng to figure out when they are crossing to buy or sell
ma_1 = 30 
ma_2 = 100

#we are looking from the last past 3 years to now 
...
#TRADING DECISIONS min 8.58 https://www.youtube.com/watch?v=FEDBsbTFG1o 

buy_signals = []
sell_signals = []
trigger = 0 #current state to record changes
